/**
 * Mapbox Configuration for Offline Maps
 * Alberta Health Connect - Rural Emergency Services
 */
...
// Alberta regions for offline map downloads
export const ALBERTA_REGIONS = [
  {
    id: 'all-alberta',
    name: '⭐ Entire Alberta Province',
    bounds: [
      [-120.0, 49.0], // Southwest corner of Alberta
      [-110.0, 60.0], // Northeast corner of Alberta
    ],
    center: [-115.0, 54.5], // Center of Alberta
    zoom: 6,
...
export const MAPBOX_STYLES = {
  ...
  outdoors: 'mapbox://styles/mapbox/outdoors-v12', // Good for rural areas
...
export const OFFLINE_PACK_CONFIG = {
  // Maximum number of tiles to download per region
  // Adjust based on storage constraints
  maxTileCount: 6000,
  
  // Zoom levels to include in offline pack
  // Lower range = smaller download size
  minZoom: 10,
  maxZoom: 15,
  
  // Include metadata for offline use
